---
title: ".NET"
description: "Turn a .NET class into a remotely callable backend service with Graftcode Gateway - no controllers, no REST routes, no OpenAPI specs. Any public method becomes instantly available to call from any language."
---
