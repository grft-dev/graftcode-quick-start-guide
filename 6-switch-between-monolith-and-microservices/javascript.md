...
> The exact package name and registry URL are shown in Graftcode Vision - copy them from there. `javonet-nodejs-sdk` is still required for this example today, but that extra step is temporary.
